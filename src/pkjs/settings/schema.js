  ...
  tabs: [{
    ...
    { id: 'watch', label: 'Watch', sections: [
      ...
      { title: 'Calendar', items: [
        ...
        { type: 'searchSelect', messageKey: 'holidayCountry', label: 'Holidays', defaultValue: 'US',
        ...
        { type: 'searchSelect', messageKey: 'holidayRegionDE', label: 'Region', defaultValue: 'all', joinPrevious: true,
          options: holidayData.REGION_OPTIONS.DE, showWhen: { key: 'holidayCountry', eq: 'DE' } },
        { type: 'searchSelect', messageKey: 'holidayRegionAT', label: 'Region', defaultValue: 'all', joinPrevious: true,
          options: holidayData.REGION_OPTIONS.AT, showWhen: { key: 'holidayCountry', eq: 'AT' } },
        { type: 'searchSelect', messageKey: 'holidayRegionCH', label: 'Region', defaultValue: 'all', joinPrevious: true,
          options: holidayData.REGION_OPTIONS.CH, showWhen: { key: 'holidayCountry', eq: 'CH' } },
        { type: 'searchSelect', messageKey: 'holidayRegionES', label: 'Region', defaultValue: 'all', joinPrevious: true,
          options: holidayData.REGION_OPTIONS.ES, showWhen: { key: 'holidayCountry', eq: 'ES' } },
        { type: 'searchSelect', messageKey: 'holidayRegionGB', label: 'Region', defaultValue: 'all', joinPrevious: true,
          options: holidayData.REGION_OPTIONS.GB, showWhen: { key: 'holidayCountry', eq: 'GB' } },
        { type: 'searchSelect', messageKey: 'holidayRegionUS', label: 'State', defaultValue: 'all', joinPrevious: true,
