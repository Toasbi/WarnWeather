// src/pkjs/settings/preview-blocks.js — ES5, WebView. WarnWeather's BLOCK
// RENDERERS: the SVG forecast/radar/layout previews (with their drift-tested
// mirrors of watch math — rain tiers, pressure curves, wind ceilings) and the
// devStats/lastFetch HTML tables. Split out of blocks.js, which keeps the
// threshold-sheet machinery and the small resolvers; this file's only outward
...
(function () {
    ...
    // <script> exposing window.StatusLineCatalog in the webview.
