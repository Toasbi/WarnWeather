 ...
 *   platform-independent now that the line styling rides the Clay message, save one
 *   gate: a feels line is dropped on aplite, which cannot draw it (feelsLineDrawn).
