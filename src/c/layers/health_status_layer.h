...
// false; set before the first layout/paint. See health_status_layout() and the
// ViewSpec's status_tier field (view_spec_unpack()/view_spec_resolve() in windows/layout.c).
