...
* **First-run setup wizard** — a quick, skippable guide that infers your country to pick sensible weather and radar providers, then walks you through layout, radar, and health. Re-runnable any time from **More → Run setup again**.
