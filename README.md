...
**Calendar**
* 3 week calendar
* Compact top view (default): a 2-row calendar (this week + next) with a larger status line and a taller forecast/health area — toggle off for the classic 3-row calendar
