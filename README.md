...
* Threshold highlighting: outline or fill a status slot when air quality, pollen, wind, gusts, steps, sleep, or distance crosses a warn or danger level you set
