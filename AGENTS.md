...
| `resources/img/clock-*~*.png`, `src/c/layers/clock_glyphs_metrics.h` (committed) | `FACES` in `scripts/gen-clock-glyphs.py` | that script, run by hand (`pip install freetype-py pillow`) |
